...
public class LanguageService
{
    ...
    private static readonly Dictionary<string, string> Dutch = new()
    {
        ...
        ["Copied"] = "Gekopieerd!",
        ["DeleteSessionConfirm"] = "Weet je zeker dat je deze hanchan wilt verwijderen?",
        ...
        ["SessionSaved"] = "Hanchan succesvol opgeslagen!",
        ["PastSessionReadOnly"] = "Dit is een afgeronde hanchan. Alleen-lezen.",
        ...
        ["NoSessionsYet"] = "Nog geen hanchans vastgelegd.",
        ["CreateFirstSession"] = "Maak je eerste hanchan",
        ["PresentPlayers"] = "Aanwezige spelers",
        ["AbsentPlayers"] = "Afwezige spelers",
        ["DeleteSession"] = "Hanchan verwijderen",
        ...
        ["NoSessionData"] = "Nog geen hanchangegevens.",
        ["Legend"] = "Legenda",
        ...
        ["ExportDescription"] = "Exporteer alle leden en hanchans naar een JSON-bestand.",
        ["ExportToFile"] = "Exporteren naar bestand",
        ["ExportSuccess"] = "Gegevens succesvol geëxporteerd!",
        ["ImportData"] = "Gegevens importeren",
        ["ImportDescription"] = "Importeer leden en hanchans uit een eerder geëxporteerd JSON-bestand. Dit vervangt alle huidige gegevens.",
        ["ImportFromFile"] = "Importeren uit bestand",
        ["ImportConfirm"] = "Let op: importeren vervangt alle huidige gegevens (leden en hanchans). Weet je het zeker?",
        ...
        ["WorkflowDesc"] = "Volg de onderstaande stappen om een hanchan voor te bereiden en af te ronden.",
        ...
        ["BackToWorkflowHint"] = "Sla eerst de hanchan op.",
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["StartSession"] = "Start Hanchan",
        ["WeeklySessionDesc"] = "Track attendance and assign tables.",
        ["ViewHistory"] = "View History",
        ["HistoryDesc"] = "View past hanchans and player statistics.",
        ["ViewMatrix"] = "View Matrix",
        ["MeetingMatrixDesc"] = "See how often each pair of players has met.",
        ["WorkflowHomeDesc"] = "Follow the step-by-step guide to prepare and finalize a hanchan.",
        ...
        ["Copied"] = "Copied!",
        ["DeleteSessionConfirm"] = "Are you sure you want to delete this hanchan?",
        ...
        ["SessionSaved"] = "Hanchan saved successfully!",
        ["PastSessionReadOnly"] = "This is a past hanchan that has been finalized. It is read-only.",
        ...
        // History page
        ["SessionHistory"] = "Hanchan History",
        ["NoSessionsYet"] = "No hanchans recorded yet.",
        ["CreateFirstSession"] = "Create your first hanchan",
        ["PresentPlayers"] = "Present Players",
        ["AbsentPlayers"] = "Absent Players",
        ["DeleteSession"] = "Delete Hanchan",
        ...
        ["ExportDescription"] = "Export all members and hanchans to a JSON file.",
        ["ExportToFile"] = "Export to file",
        ["ExportSuccess"] = "Data exported successfully!",
        ["ImportData"] = "Import Data",
        ["ImportDescription"] = "Import members and hanchans from a previously exported JSON file. This replaces all current data.",
        ["ImportFromFile"] = "Import from file",
        ["ImportConfirm"] = "Warning: importing will replace all current data (members and hanchans). Are you sure?",
        ...
        // Workflow page
        ["Workflow"] = "Workflow",
        ["WorkflowDesc"] = "Follow the steps below to prepare and finalize a hanchan.",
        ...
        ["WfStep3Title"] = "Step 3: Set up the hanchan",
        ["WfStep3Desc"] = "Administer attendance, generate table assignments, and save the hanchan.",
