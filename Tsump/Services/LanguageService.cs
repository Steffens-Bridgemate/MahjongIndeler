...
public class LanguageService
{
    ...
    private static readonly Dictionary<string, string> Dutch = new()
    {
        ...
        ["WfStep2Desc"] = "Importeer het bestand met de clubgegevens.",
        ["WfStep2Button"] = "Naar Gegevensbeheer",
        ["WfStep3Title"] = "Stap 3: Zitting instellen",
        ["WfStep3Desc"] = "Stel de aanwezigheid in, genereer de tafelindeling en sla de hanchan op.",
        ...
        ["WfStep4Desc"] = "Exporteer de bijgewerkte gegevens naar de Downloads-map.",
        ["WfStep4TitleSaveAs"] = "Stap 4: Gegevens opslaan",
        ["WfStep4DescSaveAs"] = "Sla de bijgewerkte gegevens op.",
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["WfStep2Desc"] = "Import the file with the club data.",
        ...
        ["WfStep4Desc"] = "Export the updated data to the Downloads folder.",
        ["WfStep4TitleSaveAs"] = "Step 4: Save the updated data",
        ["WfStep4DescSaveAs"] = "Save the updated data.",
