...
public class LanguageService
{
    ...
    private static readonly Dictionary<string, string> Dutch = new()
    {
        ...
        ["WfStep3aTitle"] ="Stap 3a: Indeling bekend maken",
        ["WfStep3aDesc"]="Indeling naar het klembord kopiëren en in de appgroup plakken.",
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["WfStep3aTitle"] = "Step 3a: Publish the table assignments",
        ["WfStep3aDesc"] = "Copy the assignments to the clipboard and paste them in the app group.",
